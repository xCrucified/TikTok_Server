...
namespace data_access.data
{
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder builder)
        {
            ...
            {
                new User() {Id = "1", UserName = "admin", Balance = 99999, PhoneNumber = "123456789", Followers = -1, Followings = 0, Description = "admin"},
                new User() {Id = "2", UserName = "user1", Balance = 1000, PhoneNumber = "234567890", Followers = 10, Followings = 5, Description = "user1"},
                new User() {Id = "3",  UserName = "user2", Balance = 2000, PhoneNumber = "345678901", Followers = 20, Followings = 10, Description = "user2"},
                new User() {Id = "4",  UserName = "user3", Balance = 3000, PhoneNumber = "456789012", Followers = 30, Followings = 15, Description = "user3"},
                new User() {Id = "5",  UserName = "user4", Balance = 4000, PhoneNumber = "567890123", Followers = 40, Followings = 20, Description = "user4"},
                new User() {Id = "6",  UserName = "user5", Balance = 5000, PhoneNumber = "678901234", Followers = 50, Followings = 25, Description = "user5"},
                new User() {Id = "7",  UserName = "user6", Balance = 6000, PhoneNumber = "789012345", Followers = 60, Followings = 30, Description = "user6"},
                new User() {Id = "8",  UserName = "user7", Balance = 7000, PhoneNumber = "890123456", Followers = 70, Followings = 35, Description = "user7"},
                new User() {Id = "9",  UserName = "user8", Balance = 8000, PhoneNumber = "901234567", Followers = 80, Followings = 40, Description = "user8"},
                new User() {Id = "10", UserName = "user9", Balance = 9000, PhoneNumber = "012345678", Followers = 90, Followings = 45, Description = "user9"},
            });
                ...
                new Video() { Id = 10, PublishDate = DateTime.Now, UserId = "10", Title = "test10", isPrivate = false, VideoUrl = "https://www.youtube.com/watch?v=60ItHLz5WEA" },
            });
